...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe('images', async () => {
    ...
    it('creates images', async () => {
      ...
      // FAILURE: image must have have description
      await decentragram.uploadImage(hash, '', {from: author}).should.be.rejected

      // FAILURE: image must have an author
      await decentragram.uploadImage(hash, 'Image Description', {from: null}).should.be.rejected
    })
    ...
    it('allows users to tip images', async () => {
      // Track author balance before being tipped
      ...
      let tippedAmount = await web3.utils.toWei('1', 'Ether')
